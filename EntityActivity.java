...
public class EntityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSearchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                label_pic.clear();
                adapter = new OneExpandAdapter(EntityActivity.this, new ArrayList<HashMap<String, String>>());
    ...
    private void requestData() {
        ...
        for (int i = 0; i < label.size(); i++) {
            ...
            for (HashMap.Entry<String, String> entry : label_property.get(i).details.entrySet()) {
                output1 += entry.getKey() + " : " + entry.getValue() + "\n";
            }
            item.put("Property", output1);
    ...
    public class OneExpandAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (position < label_pic.size() && label_pic.get(position) != null) {
